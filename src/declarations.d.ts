...
type RuntimeMessage = RuntimeMessageSwitchToOrOpenTaskTab | RuntimeMessageResponseSuccess | RuntimeMessageResponseFail | RuntimeMessageRequestClickUpTaskInfo | RuntimeMessageResponseClickUpTaskInfo | RuntimeMessageResponseClickUpTaskDoesNotExist | RuntimeMessageResponseClickUpNetworkError | RuntimeMessageResponseClickUpNoAuthentication // add additonal message types as union
